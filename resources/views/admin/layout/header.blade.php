...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <!-- <li class="nav-item d-none d-sm-inline-block">
        ...
        <a href="/editdoctor/{{$_SESSION['userid']}}" class="nav-link">My Profile</a>
        @elseif($_SESSION['userrole']=='patient')
        <a href="/editpatient/{{$_SESSION['userid']}}" class="nav-link">My Profile</a>
        @else
        <a href="/editdoctor/{{$_SESSION['userid']}}" class="nav-link">My Profile</a>
        @endif
      </li> -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Clinic24  ({{ucwords($_SESSION['userrole'])}} Panel)</span>
    </a>
