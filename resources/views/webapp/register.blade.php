	        ...
	        <div class="col-md-7 py-5">
		      ...
		      <div class="col-md-5 d-flex">
	        	...
	        	<div class="appointment-wrap bg-white p-4 p-md-5 d-flex align-items-center">
		        	<form action="/saveuser" method="POST" class="appointment-form ftco-animate" enctype="multipart/form-data">
		        	{{ csrf_field() }}	
					@if(session()->has('message'))
                                                  ...
                                                  <div class="alert alert-danger m-auto text-center alert-dismissible">
                                                          <strong>Error!! </strong> {{ session()->get('errror') }}
                                                          <button type="button" class="close mt-0" data-dismiss="alert">&times;</button>
                                                      </div>
                                                  @endif
						<h3>Register</h3>
		    				<div class="">
			    				<div class="form-group">
			    					<input type="text" class="form-control" name="name" placeholder="Enter Name*" @if(isset($_SESSION['userid'])) value="{{$_SESSION['username']}}" @endif required>
			    				</div>
			    				
		    				</div>
							<div class="">
			    				<div class="form-group">
			    					<input type="email" class="form-control" name="email" @if(isset($_SESSION['userid'])) value="{{$_SESSION['useremail']}}" @endif placeholder="Enter Email*" required>
			    				</div>
			    				
		    				</div>
							<div class="">
			    				<div class="form-group">
			    					<input type="tel" class="form-control" @if(isset($_SESSION['userid'])) value="{{$_SESSION['userphone']}}" @endif name="phone" placeholder="Enter Contact Number*" maxlength="10" required>
			    				</div>
	                      ...
	                      <select name="role" id="" class="form-control" required>
	                        ...
	                        <option value="Ppatient">Patient</option>
