...
class UserController extends Controller
{
    ...
    public function saveappointment(Request $request)
    {
      if(!isset($_SESSION))
      {
        ...
        $checkpackage=Purchase::where('user_id',$_SESSION['userid'])->where('status','1')->orderBy('id','DESC')->get();
        return view('webapp.create-listing',compact('data','vehicletypes','sources','checkpackage'));
    }
