	        	...
	        	<div class="appointment-wrap bg-white p-4 p-md-5 d-flex align-items-center">
					...
					@if(session()->has('message'))
						...
						<h3>Book Appointment</h3>
							...
							<div class="">
			    				<div class="form-group">
			    					<input type="tel" class="form-control" @if(isset($_SESSION['userid'])) value="{{$_SESSION['userphone']}}" @endif name="phone" placeholder="Enter Contact Number*" required>
			    				</div>
	                      ...
	                      <select name="doctor" id="" class="form-control" required>
		    				...
		    				<div class="">
			            		...
			            		<input type="time" min="05:00" max="00:00" step="00:15" class="form-control appointment_time" name="time" placeholder="Select Time*" required>
		            		</div>
			    				</div>
		    				</div>
		    				<div class="">
