	        ...
	        <div class="col-md-7 py-5">
		      ...
		      <div class="col-md-5 d-flex">
	        	<div class="appointment-wrap bg-white p-4 p-md-5 d-flex align-items-center">
		        	<form action="/saveconsultation" method="POST" class="appointment-form ftco-animate" enctype="multipart/form-data">
		        	{{ csrf_field() }}	
						<h3>Free Consultation</h3>
							...
							<div class="">
			    				<div class="form-group">
			    					<input type="tel" class="form-control" name="phone" placeholder="Enter Contact Number" required>
			    				</div>
	                      ...
	                      <select name="service" id="" class="form-control">
		    				...
		    				<div class="">
			            		...
			            		<input type="date" class="form-control appointment_date" name="date" placeholder="Select Date">
		            		</div>
			    				</div>
			    				<div class="form-group">
			    					<div class="input-wrap">
			            		<div class="icon"><span class="ion-ios-clock"></span></div>
			            		<input type="time" class="form-control appointment_time" name="time" placeholder="Select Time">
		            		</div>
			    				</div>
		    				</div>
		    				<div class="">
