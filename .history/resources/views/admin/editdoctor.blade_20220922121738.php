...
@if(session()->has('message'))
        ...
        <div class="card-body">
          <div class="row">
            ...
            <button style="margin: 0 auto;" type="submit" class="btn btn-primary">Edit Doctor</button>
            <!-- /.col -->
...
<!-- The Modal -->
<div class="modal" id="changePassword{{$doctordata->id}}">
                                                   <div class="modal-dialog">
                                                      <div class="modal-content">
                                                         <!-- Modal Header -->
                                                         <div class="modal-header">
                                                            <h4 class="modal-title">Change Password ({{$doctordata->name}})</h4>
                                                         ...
                                                         <div class="modal-body">
                                                            ...
                                                            {{ csrf_field() }}
                                                               ...
                                                               <input type="hidden" name="userid" value="{{$doctordata->id}}">
                                                               <div class="form-group">
