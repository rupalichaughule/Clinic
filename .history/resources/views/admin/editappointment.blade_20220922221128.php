            ...
            <div class="col-md-6">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select class="form-control select2" id="state" name="doctor" required>
                                            ...
                                            <option value="{{$doctorsnew->id}}" @if($doctorsnew->service==$doctorsnew->id) selected @endif>{{$doctorsnew->name}}</option>
                                            @endforeach
                                        </select>
                </div> 
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="Select Time" value="{{$appointmentdata->time}}" type="time" name="time" required>
                </div> 
              </div>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  <label>Message</label>
                  <textarea class="form-control" placeholder="Enter Message" name="message" required>{{$appointmentdata->message}}</textarea>
                </div> 
              </div>
