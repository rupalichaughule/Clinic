...
<head>
  ...
  <title>Admin</title>
<!-- Favicons -->
<link href="/webapp/assets/img/{{$headersdata['headerwebsitedata']->favicon}}" rel="icon">
...
<div class="wrapper">
  ...
  <!-- <div class="preloader flex-column justify-content-center align-items-center">
    ...
    <img class="animation__shake" src="/webapp/assets/img/{{$headersdata['headerwebsitedata']->logo}}" alt="Logo" height="60" width="60">
  </div> -->
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/admin/edituser/{{$_SESSION['adminid']}}" class="nav-link">My Profile</a>
      </li>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Car Pooling</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="/webapp-assets/images/user-images/{{$_SESSION['adminphoto']}} " class="img-circle elevation-2" alt="Admin Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">{{$_SESSION['adminname']}} 
          </a>
        </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/admin/listings" class="nav-link {{Request::is('admin/listings')?'active' : '' }}">
          ...
          <li class="nav-item">
            <a href="/admin/vehicletypes" class="nav-link {{Request::is('admin/vehicletypes')?'active' : '' }}">
          ...
          <!-- <li class="nav-item">
            <a href="/admin/sources" class="nav-link {{Request::is('admin/sources')?'active' : '' }}">
          ...
          <li class="nav-item">
            <a href="/admin/destinations" class="nav-link {{Request::is('admin/destinations')?'active' : '' }}">
          ...
          <li class="nav-item">
            <a href="/admin/purchases" class="nav-link {{Request::is('admin/purchases')?'active' : '' }}">
          ...
          <li class="nav-item">
            <a href="/admin/ads" class="nav-link {{Request::is('admin/ads')?'active' : '' }}">
          ...
          <li class="nav-item">
            <a href="/admin/websitesettings" class="nav-link {{Request::is('admin/websitesettings')?'active' : '' }}">
