            ...
            <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select class="form-control select2" id="state" name="service" required>
                                            ...
                                            <option value="Neurology" @if($doctordata->status=='Neurology') selected @endif>Neurology</option>
                                            <option value="Cardiology" @if($doctordata->status=='Cardiology') selected @endif>Cardiology</option>
                                            <option value="Dental" @if($doctordata->status=='Dental') selected @endif>Dental</option>
                                            <option value="Ophthalmology" @if($doctordata->status=='Ophthalmology') selected @endif>Ophthalmology</option>
                                            <option value="Other Services" @if($doctordata->status=='Other Services') selected @endif>Other Services</option>
                                        </select>
                </div> 
              </div>
