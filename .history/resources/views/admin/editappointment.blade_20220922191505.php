            ...
            <div class="col-md-6">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="Select Date" value="{{$doctordata->email}}" type="date" name="date" required>
                </div> 
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="Select Time" value="{{$doctordata->email}}" type="time" name="time" required>
                </div> 
              </div>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  <label>Message</label>
                  <textarea class="form-control" placeholder="Enter Message" name="message" required>{{$doctordata->email}}</textarea>
                </div> 
              </div>
