            ...
            <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select class="form-control select2" id="state" name="service" required>
                                            ...
                                            <option value="Neurology" @if($doctordata->status=='1') selected @endif>Neurology</option>
                                            <option value="Cardiology" @if($doctordata->status=='1') selected @endif>Cardiology</option>
                                            <option value="Dental" @if($doctordata->status=='1') selected @endif>Dental</option>
                                            <option value="Ophthalmology" @if($doctordata->status=='1') selected @endif>Ophthalmology</option>
                                            <option value="Other Services" @if($doctordata->status=='1') selected @endif>Other Services</option>
                                        </select>
                </div> 
              </div>
