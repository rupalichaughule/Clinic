...
Route::GET('/inactiveappointmentstatus/{id}', 'admin\AdminController@inactiveappointmentstatus');
Route::GET('/activeappointmentstatus/{id}', 'admin\AdminController@activestatus');
