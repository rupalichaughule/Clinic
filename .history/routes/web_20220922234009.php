...
//Appointment
Route::GET('/patients', 'admin\AppointmentController@patients');
Route::POST('/savepatient', 'admin\AppointmentController@savepatient');
Route::GET('/editpatient/{id}', 'admin\AppointmentController@editpatient');
Route::POST('/updatepatient/{id}', 'admin\AppointmentController@updatepatient');
Route::GET('/deletepatient/{id}', 'admin\AppointmentController@deletepatient');
