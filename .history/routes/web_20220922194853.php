...
Route::POST('/saveuser', 'admin\DoctorController@saveuser');
Route::GET('/edituser/{id}', 'admin\DoctorController@edituser');
Route::POST('/updateuser/{id}', 'admin\DoctorController@updateuser');
Route::GET('/deleteuser/{id}', 'admin\DoctorController@deleteuser');
