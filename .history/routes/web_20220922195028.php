...
Route::POST('/saveuser', 'admin\AppointmentController@saveuser');
Route::GET('/edituser/{id}', 'admin\AppointmentController@edituser');
Route::POST('/updateuser/{id}', 'admin\AppointmentController@updateuser');
Route::GET('/deleteuser/{id}', 'admin\AppointmentController@deleteuser');
