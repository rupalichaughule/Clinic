...
//doctors
Route::GET('/doctors', 'admin\DoctorController@users');
Route::POST('/doctoruser', 'admin\DoctorController@saveuser');
Route::GET('/doctoruser/{id}', 'admin\DoctorController@edituser');
Route::POST('/doctorteuser/{id}', 'admin\DoctorController@updateuser');
Route::GET('/doctorteuser/{id}', 'admin\DoctorController@deleteuser');


//patients
Route::GET('/patients', 'admin\PatientController@users');
Route::POST('/patientuser', 'admin\PatientController@saveuser');
Route::GET('/patientuser/{id}', 'admin\PatientController@edituser');
Route::POST('/patientteuser/{id}', 'admin\PatientController@updateuser');
Route::GET('/patientteuser/{id}', 'admin\PatientController@deleteuser');
