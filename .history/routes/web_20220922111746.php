...
//users
Route::GET('/admin/users', 'admin\DoctorController@users');
Route::POST('/admin/saveuser', 'admin\DoctorController@saveuser');
Route::GET('/admin/edituser/{id}', 'admin\DoctorController@edituser');
Route::POST('/admin/updateuser/{id}', 'admin\DoctorController@updateuser');
Route::GET('/admin/deleteuser/{id}', 'admin\DoctorController@deleteuser');
