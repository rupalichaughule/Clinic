	        	...
	        	<div class="appointment-wrap bg-white p-4 p-md-5 d-flex align-items-center">
					...
					<?php if(session()->has('message')): ?>
						...
						<h3>Book Appointment</h3>
							...
							<div class="">
			    				<div class="form-group">
			    					<input type="tel" class="form-control" <?php if(isset($_SESSION['userid'])): ?> value="<?php echo e($_SESSION['userphone']); ?>" <?php endif; ?> name="phone" placeholder="Enter Contact Number*" maxlength="10" required>
			    				</div>
